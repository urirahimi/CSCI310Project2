...
<html>
	...
	<body>
		...
		<div id="outside-div">
			<div id="title">
				<h1>Collage for topic <div style="display: inline" id="collage-topic"><%= session.getAttribute("query") %></div></h1> <!-- TODO: collage title needs to be hooked up, also need to EXPORT --> 
			</div>
			...
			<div id="build-another">
				<form name="myform" method="POST" action="${pageContext.request.contextPath}/search">
					...
					<div class="input-div">
						<input id="build-button" type="submit" name="submit" value="Build Another Collage" />
					</div>
				</form>
			</div>
			<div id="previous-collages">
				...
				<div class="prevs-div"> 
					<a onclick="changeDisplayedImage(<%= i %>)"><img class="prevs-img" src="<%= list.get(i).getImage() %>"></a>
