...
public class CollageBuilder
{
	...
	public static int collageWidth = 800;
	public static int collageHeight = 600;
	...
	private static BufferedImage buildImage(List<BufferedImage> images, int width, int height, Character shape, Boolean rotate)
	{
	...
	public static BufferedImage buildCollage (List<BufferedImage> images, String letters, Boolean rotate, String filter, Boolean border, int width, int height)
	{

		// formatImages is a helper function used to format images (resize, add border)
		images = formatImages(images, filter, border);
		...
		for(int i =0; i<letters.length();i++)
		{
			...
			listImages.add(buildImage(images,collageWidth,collageHeight,Character.toUpperCase(letter),rotate));
		}
		
		for(int i =0; i<listImages.size();i++)
		{
			listImages.set(i, resizeImage(collageWidth/listImages.size(), collageHeight, listImages.get(i)));
		}
		...
		return resizeImage(width,height,result);
		//assert (images.size() == 30);
	 ...
	 * @return
	 */
	private static List<BufferedImage> formatImages (List<BufferedImage> images, String filter, boolean border)
	{
